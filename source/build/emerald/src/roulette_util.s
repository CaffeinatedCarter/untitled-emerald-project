...
sub_8151678:
	...
	bx	r0
.Lfe1:
	.size	 sub_8151678,.Lfe1-sub_8151678
	.align	2, 0
	.globl	sub_815168C
	.type	 sub_815168C,function
	.thumb_func
sub_815168C:
	push	{r4, r5, r6, r7, lr}
	add	r3, r0, #0
...
.L8:
	...
	bx	r1
.Lfe2:
	.size	 sub_815168C,.Lfe2-sub_815168C
	.align	2, 0
	.globl	sub_8151710
	.type	 sub_8151710,function
	.thumb_func
sub_8151710:
	push	{r4, lr}
	add	r2, r0, #0
...
.L13:
	...
	bx	r1
.Lfe3:
	.size	 sub_8151710,.Lfe3-sub_8151710
	.align	2, 0
	.globl	sub_8151744
	.type	 sub_8151744,function
	.thumb_func
sub_8151744:
	push	{r4, r5, r6, r7, lr}
	mov	r7, sl
...
.L37:
	...
	bx	r1
.Lfe4:
	.size	 sub_8151744,.Lfe4-sub_8151744
	.align	2, 0
	.globl	sub_815194C
	.type	 sub_815194C,function
	.thumb_func
sub_815194C:
	push	{r4, r5, lr}
	add	r3, r0, #0
...
.L64:
	...
	.word	gPlttBufferUnfaded
.Lfe5:
	.size	 sub_815194C,.Lfe5-sub_815194C
	.align	2, 0
	.globl	task_tutorial_controls_fadein
	.type	 task_tutorial_controls_fadein,function
	.thumb_func
task_tutorial_controls_fadein:
	push	{r4, r5, r6, lr}
	add	r4, r0, #0
	mov	r5, #0x0
	ldrb	r0, [r4]
...
.L67:
	...
	bx	r0
.Lfe6:
	.size	 task_tutorial_controls_fadein,.Lfe6-task_tutorial_controls_fadein
	.align	2, 0
	.globl	sub_8151A48
	.type	 sub_8151A48,function
	.thumb_func
sub_8151A48:
	push	{r4, r5, r6, r7, lr}
	add	r3, r0, #0
...
.L80:
	...
	bx	r0
.Lfe7:
	.size	 sub_8151A48,.Lfe7-sub_8151A48
	.align	2, 0
	.globl	sub_8151A9C
	.type	 sub_8151A9C,function
	.thumb_func
sub_8151A9C:
	push	{r4, r5, r6, r7, lr}
	add	sp, sp, #-0x4
...
.L98:
	...
	bx	r0
.Lfe8:
	.size	 sub_8151A9C,.Lfe8-sub_8151A9C
	.align	2, 0
...
.L206:
	...
	bx	r0
.Lfe16:
	.size	 sub_8152008,.Lfe16-sub_8152008
	.align	2, 0
	.globl	sub_8152058
	.type	 sub_8152058,function
	.thumb_func
sub_8152058:
	push	{r4, r5, r6, r7, lr}
	add	r7, r0, #0
...
.L217:
	...
	bx	r0
.Lfe17:
	.size	 sub_8152058,.Lfe17-sub_8152058
.text
	.align	2, 0
